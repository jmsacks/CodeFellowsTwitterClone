//
//  SingleUserTweetsViewController.swift
//  TwitterClone
//
//  Created by Joshua M. Sacks on 10/9/14.
...
//import Social
//
//class SingleUserTweetsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
//    var nib = UINib(nibName: "customTweetView", bundle: NSBundle.mainBundle())
//    var refrenceTweet : Tweet!
//    
...
//        
//        self.networkController.fetchSpecificusersTimeLine(refrenceTweet, {(errorDescription, tweets) -> (Void) in
//            
